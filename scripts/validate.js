...
function incrementSeconds() {
    ...
    for(let i=0;i<playerAmountValue;i++){
        document.querySelector(".gameWindow__tableBox__table--tr-1").appendChild(tableHeader[i])
    ...
    function recordTable(lineNumber){
        ...
        console.log(clickCount,playerAmountValue,lineNumber,itemCount,next,playerResult)
